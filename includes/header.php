         ...
         <ul class="navbar-nav me-auto mb-2 mb-lg-0">
           ...
           <?php
            ...
            ?>
             ...
             <li class="nav-item self-justify-end">
               <a class="nav-link " style=" font-size: 2rem" href="index.php"><?= $_SESSION['email']; ?> </a>
             </li>
             <li class="nav-item self-justify-end">
               <a class="nav-link " style=" font-size: 2rem" href="logout.php">déconnexion </a>
             </li>
           <?php } else {
            ?>
             </li>
             <li class="nav-item self-justify-end">
               <a class="nav-link " style=" font-size: 2rem" href="login.php">connexion </a>
             </li>
           <?php } ?>
         </ul>
